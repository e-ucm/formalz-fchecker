...
public class Utils {
	...
	private static String showArgs(String s, Object[] x) {
		...
		for (int i=0; i<x.length; i++) {
			...
			else if (o instanceof int[]) s += showArray1(toObjArray((int[]) o)) ;
			else if (o instanceof boolean[]) s += showArray1(toObjArray((boolean[]) o )) ;
			else if (o instanceof double[]) s += showArray1(toObjArray((double[]) o )) ;
			else if (o instanceof String[]) s += showArray1(toObjArray((String[]) o )) ;
			else if (o instanceof Set) s += showSet((Set) o) ;
		}
		return s ;
	}
	
	private static String showArray1(Object[] a) { return "[" + showList(a) + "]" ; }
	private static String showSet(Set a) { return "{" + showList(a.toArray() ) + "}" ; }

	private static String showList(Object[] a) {
		String s = "" ;
	...
	private static Object[] toObjArray(int[] a) {
		Object[] a_ = new Object[a.length] ;
		for (int i = 0; i<a.length; i++) a_[i] = a[i] ;
		return a_ ;
	}
	
	private static Object[] toObjArray(boolean[] a) {
		Object[] a_ = new Object[a.length] ;
		for (int i = 0; i<a.length; i++) a_[i] = a[i] ;
		return a_ ;
	}

	private static Object[] toObjArray(double[] a) {
		Object[] a_ = new Object[a.length] ;
		for (int i = 0; i<a.length; i++) a_[i] = a[i] ;
		return a_ ;
	}
	
	private static Object[] toObjArray(String[] a) {
		Object[] a_ = new Object[a.length] ;
		for (int i = 0; i<a.length; i++) a_[i] = a[i] ;
		return a_ ;
	}
